...
$ekg_tabs = array(
        "index.php"		=> "informacje",
        "docs.php"		=> "dokumentacja",
//	"changelog.php"		=> "zmiany",
        "download.php"		=> "download",
	"screenshots.php" 	=> "screenshoty",
	"authors.php" 		=> "autorzy",
        "contact.php" 		=> "kontakt",
//	"support.php"  		=> "wsparcie",
//	"sponsors.php" 		=> "sponsorzy",
	"http://bugs.ekg2.org" 	=> "wiki/bugi"
);
...
<div id="main">
  <div id="titlebar">
    ...
    <div id="titlebartext">
<?
    echo '<a href="http://en.ekg2.org' . $_SERVER['SCRIPT_NAME'] . '">  English  </a>';
?>
    </div>
  </div>
  <div id="srodek">
